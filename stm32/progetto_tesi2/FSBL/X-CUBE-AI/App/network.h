...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "lis_dnn_model_quant_2"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (42)
...
#define LL_ATON_DEFAULT_OUT_1_SIZE_BYTES  (26)
